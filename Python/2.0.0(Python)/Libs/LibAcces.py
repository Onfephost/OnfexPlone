...
def loadLib(node,lib,path=None):
    if lib in ["neomOnfex","tymess","taphlot","osp","karchenter",
               "meathess","rundom","estorge","quant","onfextrode","kalfenDowpownen"]:
        match lib:
            case "neomOnfex":              
            ...
            case "osp":            
                ...
                return lib.main(node,False,path)
            ...
            case "kalfenDowpownen":
                from Libs.kalfenDowpownen.kalfenDowpownen import main
                return main(node)
