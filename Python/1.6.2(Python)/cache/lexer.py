...
TYPES = {
    "intg","flotg","strg","boletg",
    "listh","dikth","aphe",
    "kalf","karchen","peontderen",
}

KEYWORDS = {
    "kalfen":"KALFEN","frounct":"FRCT",
    "frutupheFrounct":"PFRCT","frutuphenos":"FUTUREC",
    "ifnt":"IF","elsnt":"ELSE","efnt":"ELIF",
    "peontDelnos":"PTRDEL","forp":"FOR","perl":"PERL","eower":"WHILE",
    "keryenos":"FORPPERL","maphnos":"MAPHPERL",
    "asken":"AS","serl":"SERL","inkleodnos":"IMPORT",
    "swetchnos":"SWITCH","keoz":"CASE",
...
TOKEN_SPEC = [
    ...
    ("IDENTIFEN",r"[a-zA-Z_][a-zA-Z0-9_öüÖÜ]*"),
    ("LABEL",    r'#[^"]*#'),("SKIP",     r"[ \t\n]+"),
]
trns = {
    "IDENTIFEN":"texth","POINT":"detot(.)","COMMA":"vetot(,)",
    ...
    "SWITCH":"swetchnos","CASE":"keoz",
}
def trans(a):
    return trns.get(a,"baskeo")
